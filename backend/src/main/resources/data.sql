...
INSERT INTO messages VALUES
                            ...
                            (12, 'Not end of the line', 'You haven''t reached the end of the line+"Don''t dwell on what went wrong. Instead, focus on what to do next. Spend your energies on moving forward toward finding the answer."+ - Denis Waitley'),
                            (13, 'Not end of the line', 'You haven''t reached the end of the line+"If you focus on results, you will never change. If you focus on change, you will get results."+ - Jack Dixon'),
                            (14, 'Not end of the line', 'You haven''t reached the end of the line+"We can always choose to perceive things differently. You can focus on what''s wrong in your life, or you can focus on what''s right."+ - Marianne Williamson'),
                            (15, 'Not end of the line', 'You haven''t reached the end of the line+"Focus on where you want to go, not on what you fear."+ - Tony Robbins'),
                            (16, 'Not end of the line', 'You haven''t reached the end of the line+"I don''t focus on what I''m up against. I focus on my goals and I try to ignore the rest."+ - Venus Williams'),
                            (17, 'Not end of the line', 'You haven''t reached the end of the line+"I learned to focus and work hard and not give up. I learned that every obstacle is really an opportunity." - Jenna Ushkowitz'),
